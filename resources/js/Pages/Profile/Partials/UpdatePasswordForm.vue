<template>
    <jet-form-section @submitted="updatePassword">
        ...
        <template #description>
            Hesabınızın güvenli olmasından emin olmak için uzun bir şifreye sahip olun.
        </template>

        <template #form>
            <div class="col-span-6 sm:col-span-4">
                <jet-label for="current_password" value="Geçerli Şifre" />
            ...
            <div class="col-span-6 sm:col-span-4">
                <jet-label for="password" value="Yeni Şifre" />
            ...
            <div class="col-span-6 sm:col-span-4">
                <jet-label for="password_confirmation" value="Şifreyi Onaylayın" />
